 ...
 sig
  module Raw :
   sig
    ...
    type 'elt coq_R_mem =
    | R_mem_0 of 'elt t
    | R_mem_1 of 'elt t * nat * 'elt * (nat * 'elt) list
    | R_mem_2 of 'elt t * nat * 'elt * (nat * 'elt) list
       * bool * 'elt coq_R_mem

    val coq_R_mem_rect :
      key -> ('a1 t -> __ -> 'a2) -> ('a1 t -> nat -> 'a1 ->
      (nat * 'a1) list -> __ -> __ -> __ -> 'a2) -> ('a1 t ->
      nat -> 'a1 -> (nat * 'a1) list -> __ -> __ -> __ ->
      bool -> 'a1 coq_R_mem -> 'a2 -> 'a2) -> 'a1 t -> bool
      -> 'a1 coq_R_mem -> 'a2
    ...
    val mem_rect :
      key -> ('a1 t -> __ -> 'a2) -> ('a1 t -> nat -> 'a1 ->
      (nat * 'a1) list -> __ -> __ -> __ -> 'a2) -> ('a1 t ->
      nat -> 'a1 -> (nat * 'a1) list -> __ -> __ -> __ -> 'a2
      -> 'a2) -> 'a1 t -> 'a2
    ...
    type 'elt coq_R_find =
    | R_find_0 of 'elt t
    | R_find_1 of 'elt t * nat * 'elt * (nat * 'elt) list
    | R_find_2 of 'elt t * nat * 'elt * (nat * 'elt) list
       * 'elt option * 'elt coq_R_find

    val coq_R_find_rect :
      key -> ('a1 t -> __ -> 'a2) -> ('a1 t -> nat -> 'a1 ->
      (nat * 'a1) list -> __ -> __ -> __ -> 'a2) -> ('a1 t ->
      nat -> 'a1 -> (nat * 'a1) list -> __ -> __ -> __ -> 'a1
      option -> 'a1 coq_R_find -> 'a2 -> 'a2) -> 'a1 t -> 'a1
      option -> 'a1 coq_R_find -> 'a2
    ...
    type 'elt coq_R_add =
    | R_add_0 of 'elt t
    | R_add_1 of 'elt t * nat * 'elt * (nat * 'elt) list
    | R_add_2 of 'elt t * nat * 'elt * (nat * 'elt) list
       * 'elt t * 'elt coq_R_add

    val coq_R_add_rect :
      key -> 'a1 -> ('a1 t -> __ -> 'a2) -> ('a1 t -> nat ->
      'a1 -> (nat * 'a1) list -> __ -> __ -> __ -> 'a2) ->
      ('a1 t -> nat -> 'a1 -> (nat * 'a1) list -> __ -> __ ->
      __ -> 'a1 t -> 'a1 coq_R_add -> 'a2 -> 'a2) -> 'a1 t ->
      'a1 t -> 'a1 coq_R_add -> 'a2
    ...
    type 'elt coq_R_remove =
    | R_remove_0 of 'elt t
    | R_remove_1 of 'elt t * nat * 'elt * (nat * 'elt) list
    | R_remove_2 of 'elt t * nat * 'elt * (nat * 'elt) list
       * 'elt t * 'elt coq_R_remove
    ...
    type ('elt, 'a) coq_R_fold =
    | R_fold_0 of 'elt t * 'a
    | R_fold_1 of 'elt t * 'a * nat * 'elt
       * (nat * 'elt) list * 'a * ('elt, 'a) coq_R_fold

    val coq_R_fold_rect :
      (key -> 'a1 -> 'a2 -> 'a2) -> ('a1 t -> 'a2 -> __ ->
      'a3) -> ('a1 t -> 'a2 -> nat -> 'a1 -> (nat * 'a1) list
      -> __ -> 'a2 -> ('a1, 'a2) coq_R_fold -> 'a3 -> 'a3) ->
      'a1 t -> 'a2 -> 'a2 -> ('a1, 'a2) coq_R_fold -> 'a3
  ...
  module Raw :
   sig
    ...
    val coq_R_mem_rect :
      ...
      ('a1 t -> pt_key -> 'a1 -> (pt_key * 'a1) list -> __ ->
    ...
    | R_find_2 of 'elt t * pt_key * 'elt
       * (pt_key * 'elt) list * 'elt option * 'elt coq_R_find
    ...
    val coq_R_add_rect :
      key -> 'a1 -> ('a1 t -> __ -> 'a2) -> ('a1 t -> pt_key
      -> 'a1 -> (pt_key * 'a1) list -> __ -> __ -> __ -> 'a2)
      -> ('a1 t -> pt_key -> 'a1 -> (pt_key * 'a1) list -> __
...
val nullablePass : production list -> NtSet.t -> NtSet.t

val mkNullableSet'_func :
  (production list, NtSet.t) sigT -> NtSet.t

val mkNullableSet' : production list -> NtSet.t -> NtSet.t
...
val first_map_equiv_dec : first_map -> first_map -> bool
...
val followPass :
  production list -> nullable_set -> first_map -> follow_map
  -> follow_map

val follow_map_equiv_dec : first_map -> first_map -> bool

val mkFollowMap'_func :
  (grammar, (nullable_set, (first_map, (__, (follow_map, __)
  sigT) sigT) sigT) sigT) sigT -> follow_map
...
val fromLookaheadList :
  nonterminal -> symbol list -> lookahead list -> table_entry
  list
...
val mkEntries' :
  NtSet.t -> first_map -> LaSet.t NtMap.t -> production list
  -> table_entry list
...
val mkParseTable : table_entry list -> parse_table option
...
val parse_wrapper :
  parse_table -> symbol -> char list list -> (parse_failure,
  tree * (char list list, char list length_lt_eq) sigT) sum
